...
async function datos() {
    try {
        const consulta = await fetch("https://raw.githubusercontent.com/Miolivos/Coldplay_Trabajo-Final/main/coldplay.json");
...
function displayAlbumPopularityVisualization(data) { 
    ...
    console.log("Conteo de canciones por álbum (Map):", songCountsPerAlbum);
